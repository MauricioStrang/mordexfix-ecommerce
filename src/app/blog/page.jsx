    ...
    return(
        <div className={styles.container}>
            ...
            <div className={styles.blogsContainer}>
                ...
                <BlogCard blogImage = "/psdisc.png" blogDate = "July 25, 2024" blogLink = "/blog/best-microscopes" blogTitle = "Best Microscopes for Electronic Repair" blogDesc = "Whether you’re trying to replace the HDMI port on a PS4 or you’re reballing a BGA chip on a Macbook Pro, one thing you’ll need for sure is a good microscope."/>
                <BlogCard blogImage = "/gifts.png" blogDate = "July 20, 2024" blogLink = "/blog/best-microscopes" blogTitle = "Best Microscopes for Electronic Repair" blogDesc = "Whether you’re trying to replace the HDMI port on a PS4 or you’re reballing a BGA chip on a Macbook Pro, one thing you’ll need for sure is a good microscope."/>
                <BlogCard blogImage = "/solder.png" blogDate = "July 15, 2024" blogLink = "/blog/best-microscopes" blogTitle = "Best Microscopes for Electronic Repair" blogDesc = "Whether you’re trying to replace the HDMI port on a PS4 or you’re reballing a BGA chip on a Macbook Pro, one thing you’ll need for sure is a good microscope."/>
